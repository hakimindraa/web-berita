                ...
                <Link href={`/berita/${featured.slug}`} className="group block">
                  <article className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 md:p-6">
                      ...
                      <h1 className="text-xs md:text-2xl font-semibold leading-snug" style={{ color: '#ffffff', textShadow: '1px 1px 3px rgba(0,0,0,0.9)' }}>
                        {featured.title}
                      </h1>
            ...
            <aside className="lg:col-span-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
                <div className="flex items-center gap-2 mb-3 md:mb-4 pb-2 border-b-2 border-red-600">
                  ...
                  <h2 className="text-sm md:text-lg font-bold text-gray-900">Berita Terpopuler</h2>
                </div>
